            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              {cumulativeBelowStandard && (
                <p className="text-xs text-amber-700 bg-amber-50 rounded-lg px-3 py-2">
                  ⚠ These RECD line items total {formatINR(String(cumulative.actual))} against a combined standard price of {formatINR(String(cumulative.standard))} for {customerName} — {formatINR(String(cumulative.standard - cumulative.actual))} below standard. This won&apos;t stop you from creating the invoice.
                </p>
              )}
